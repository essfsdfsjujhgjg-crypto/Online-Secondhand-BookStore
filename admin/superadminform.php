...
$query = "SELECT * FROM superadmin $search_condition";
...
<body>
    ...
    <form method="GET" action="">
        <input type="text" name="search" placeholder="Search by Superadmin Username" value="<?php echo $search; ?>">
        ...
        <table class="animated">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="superadmindelete.php?username=<?php echo $row['username']; ?>">Delete</a></td>
                </tr>
            <?php
            }
            ?>

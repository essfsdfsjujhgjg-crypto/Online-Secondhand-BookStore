		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2" style="margin-top: 5%;">
				...
				if(isset($_POST['search'])){
					...
					$sql="select * from product WHERE Product_Name LIKE '%$searchKey%' AND ProductCategory_ID = '2'";
				}else{
					
				$sql="select * from product where ProductCategory_ID = '2' and product_isDelete=0 ";
				$searchKey = "";
				}

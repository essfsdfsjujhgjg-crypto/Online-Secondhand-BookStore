...
$query = "SELECT * FROM admin $search_condition";
...
<body>
    ...
    <form method="GET" action="">
        <input type="text" name="search" placeholder="Search by Admin Username" value="<?php echo $search; ?>">
        ...
        <table class="animated">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="adminedit2.php?username=<?php echo $row['username']; ?>">Edit</a></td>
                    <td><a href="admindelete2.php?username=<?php echo $row['username']; ?>">Delete</a></td>
                </tr>
            <?php
            }
            ?>
    ...
    <button class="add-admin-button" onclick="addAdmin()">
        <i class="icon fas fa-user-plus"></i> Add Admin
    </button>
